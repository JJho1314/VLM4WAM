...
def sample_points(mask_pred, gt_masks, num_points=12544, oversample_ratio=3.0, importance_sample_ratio=0.75):
    ...
    with torch.no_grad():
        ...
        mask_point_targets = point_sample(
            gt_masks.float(), points_coords)
    mask_point_preds = point_sample(
        mask_pred.to(torch.float32), points_coords.to(torch.float32))
