...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-mgv3-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-mgv3-%j.err
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-match_ground_v3}
...
export IMAGINAIRE_OUTPUT_ROOT=${IMAGINAIRE_OUTPUT_ROOT:-/data/user/jhe724/workspace/cosmos-predict2.5/outputs/droid_v21_match_ground_v3_iou50_vlm4wam}
...
EXPERIMENT=${EXPERIMENT:-predict2_video2world_training_2b_droid_success_v21_match_ground_v3}
JOB_NAME=${JOB_NAME:-2b_mgv3_iou50_49f_bs2accum8_gbs128_10ep1470}
