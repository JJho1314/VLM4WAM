...
#SBATCH --job-name=cosmos-matchg2k
...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-matchg2k-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-matchg2k-%j.err
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-match_ground}
...
export IMAGINAIRE_OUTPUT_ROOT=${IMAGINAIRE_OUTPUT_ROOT:-/data/user/jhe724/workspace/cosmos-predict2.5/outputs/droid_success_v21_match_ground_2000_vlm4wam}
...
JOB_NAME=${JOB_NAME:-2b_droid_success_v21_match_ground_cap200_49f_bs2accum8_gbs128_2000}
