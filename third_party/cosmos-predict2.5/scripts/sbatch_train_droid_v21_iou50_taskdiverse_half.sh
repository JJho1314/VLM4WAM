...
#SBATCH --job-name=cosmos-iou50half
...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-iou50half-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-iou50half-%j.err
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-iou50_taskdiverse_half}
...
export IMAGINAIRE_OUTPUT_ROOT=${IMAGINAIRE_OUTPUT_ROOT:-/data/user/jhe724/workspace/cosmos-predict2.5/outputs/droid_v21_iou50_taskdiverse_half_vlm4wam}
...
EXPERIMENT=${EXPERIMENT:-predict2_video2world_training_2b_droid_success_v21_match_ground}
JOB_NAME=${JOB_NAME:-2b_droid_v21_iou50_taskdiverse_half_49f_bs2accum8_gbs128_2000}
