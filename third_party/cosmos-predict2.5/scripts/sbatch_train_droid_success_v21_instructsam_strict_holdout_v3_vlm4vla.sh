...
TORCH_CACHE_JOB_ID=${SLURM_JOB_ID:-manual}
export TRITON_CACHE_DIR=${TRITON_CACHE_DIR:-/tmp/triton_cache_${USER}_${TORCH_CACHE_JOB_ID}}
export TORCHINDUCTOR_CACHE_DIR=${TORCHINDUCTOR_CACHE_DIR:-/tmp/torchinductor_${USER}_${TORCH_CACHE_JOB_ID}}
export CUDA_CACHE_PATH=${CUDA_CACHE_PATH:-/tmp/cuda_cache_${USER}_${TORCH_CACHE_JOB_ID}}
