...
class VideoAugmentation(nn.Module):
    """Weak train-time augmentation for float video clips in [0, 1].

    The same sampled parameters are applied to every frame in a camera clip so
    the augmentation is temporally consistent.
    """
