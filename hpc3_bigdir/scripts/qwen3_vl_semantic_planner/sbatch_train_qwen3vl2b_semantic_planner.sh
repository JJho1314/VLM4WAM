#!/usr/bin/env bash
# LoRA fine-tune Qwen3-VL-2B-Instruct as a continuous semantic planner.
# This uses a plain Qwen3-VL-2B-Instruct checkpoint.

#SBATCH --job-name=q3vl2b-plan-sft
...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-q3vl2b-plan-sft-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-q3vl2b-plan-sft-%j.err
...
PLAN_LABEL_DIR=${PLAN_LABEL_DIR:-$DATASET_ROOT/qwen3vl2b_semantic_plan_k6_g9}
OUTPUT_DIR=${OUTPUT_DIR:-/data/user/jhe724/workspace/VLM4WAM/outputs/qwen3vl_semantic_planner/qwen3vl2b_lora_k6_g9_pilot}
