#!/usr/bin/env bash
# Precompute Qwen3-VL continuous semantic plan labels for DROID videos.
# This uses a plain Qwen3-VL-Instruct checkpoint.

#SBATCH --job-name=q3vl-plan-label
...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-q3vl-plan-label-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-q3vl-plan-label-%j.err
...
OUTPUT_DIR=${OUTPUT_DIR:-$DATASET_ROOT/qwen3vl4b_semantic_plan_k6_g9}
...
"$PY" scripts/qwen3_vl_semantic_planner/build_qwen3vl_semantic_plan_labels.py \
