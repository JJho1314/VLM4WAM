...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-oracle-eval-ycbanana-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-oracle-eval-ycbanana-%j.err
set -euo pipefail
...
OUT=$VLM4WAM_ROOT/eval_results_oracle_iter3000_yellowcarrot_banana_$(date +%Y%m%d_%H%M%S)
...
YCCAP=/data/user/jhe724/workspace/VLM4WAM/yc74616_work/yc74616_banana_caption.txt
EPISODES=(
  "yc74616banana 0"
)
