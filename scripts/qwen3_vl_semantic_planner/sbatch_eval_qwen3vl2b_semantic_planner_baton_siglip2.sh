#!/usr/bin/env bash
# Evaluate Baton Stage-1 SigLIP2-target semantic planner checkpoint.

#SBATCH --job-name=q3vl2b-baton-siglip2-eval
...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-q3vl2b-baton-siglip2-eval-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-q3vl2b-baton-siglip2-eval-%j.err
...
RUN_DIR=${RUN_DIR:-/data/user/jhe724/workspace/VLM4WAM/outputs/qwen3vl_semantic_planner/qwen3vl2b_baton_siglip2_k6_g9_full_8gpu_b4_acc2_gbs64_3000step}
...
"$PY" scripts/qwen3_vl_semantic_planner/evaluate_qwen3vl_semantic_planner_regression.py \
