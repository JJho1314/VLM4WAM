#!/usr/bin/env bash
#SBATCH --job-name=profile_joint_k2
...
#SBATCH --output=logs/slurm-profile-joint-k2-%j.out
...
PROBE_OUTPUT_DIR=${PROBE_OUTPUT_DIR:-/data/user/jhe724/junjie/outputs/profile_joint_vlm_geact_k2}
