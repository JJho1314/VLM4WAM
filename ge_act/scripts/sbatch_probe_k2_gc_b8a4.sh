#!/usr/bin/env bash
#SBATCH --job-name=probe_k2_gc_b8a4
...
#SBATCH --output=logs/slurm-probe-k2-gc-b8a4-%j.out
...
CONFIG=${CONFIG:-$GE_ACT_ROOT/configs/ltx_model/libero/video_model_libero_joint_vlm_geact_action_k2_gc_b8a4_probe.yaml}
PROBE_OUTPUT_DIR=${PROBE_OUTPUT_DIR:-/data/user/jhe724/junjie/outputs/probe_joint_vlm_geact_action_k2_gc_b8a4}
