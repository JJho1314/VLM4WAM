#!/usr/bin/env bash
#SBATCH --job-name=cosmos-file855-t59
...
SOURCE_VIDEO=/data/user/jhe724/workspace/data/droid_success/videos/observation.images.left_external/chunk-000/file_855.mp4
STAGE="$VLM4WAM_ROOT/eval_inputs_oracle_iter3000_file855_t59_REPRO"
OUT="$VLM4WAM_ROOT/eval_results_oracle_iter3000_file855_t59_REPRO"
...
cd "$COSMOS_ROOT"
echo "=== export oracle SigLIP2 plan: file_855 frame 885 (59.000s), 49 frames ==="
...
echo "=== generate with iter3000 SG-WAM ==="
ORIG="$STAGE" \
OUT="$OUT" \
