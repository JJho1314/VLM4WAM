#!/usr/bin/env bash
#SBATCH --job-name=cosmos-file547-f0-fulltask
...
STAGE="$VLM4WAM_ROOT/eval_inputs_oracle_iter3000_file547_firstframe_bottle_microwave_fulltask_REPRO"
OUT="$VLM4WAM_ROOT/eval_results_oracle_iter3000_file547_firstframe_bottle_microwave_fulltask_REPRO"
...
cd "$COSMOS_ROOT"
echo "=== export full-task oracle plan: file_547 frame 4735, stride 5, through frame 4975 ==="
