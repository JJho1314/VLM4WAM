...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-probe-b-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-probe-b-%j.err
set -uo pipefail
...
python /data/user/jhe724/workspace/VLM4WAM/mg_eval/probe_b_contrastive_ceiling.py
echo "probe_b_exit=$?"
