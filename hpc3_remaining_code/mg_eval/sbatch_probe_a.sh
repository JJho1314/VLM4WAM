...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-probe-a-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-probe-a-%j.err
set -uo pipefail
...
python /data/user/jhe724/workspace/VLM4WAM/mg_eval/probe_a_matching_vs_noise.py
echo "probe_a_exit=$?"
