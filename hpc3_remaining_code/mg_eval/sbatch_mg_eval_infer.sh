...
torchrun --standalone --nproc_per_node=1 examples/inference.py \
  -i /data/user/jhe724/workspace/VLM4WAM/mg_eval/samples_mg.jsonl \
  --output-dir /data/user/jhe724/workspace/VLM4WAM/mg_eval/videos \
  ...
  --disable-guardrails
echo "infer_exit=$?"
ls -la /data/user/jhe724/workspace/VLM4WAM/mg_eval/videos/
