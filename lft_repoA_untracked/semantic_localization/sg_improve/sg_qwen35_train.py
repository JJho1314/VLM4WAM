...
WARMUP = int(os.environ.get("WARMUP_STEPS", 200))            # linear warmup — full-FT collapses early without it
...
def main():
    ...
    def lr_lambda(s):                                   # linear warmup -> cosine decay (per-group base lr preserved)
