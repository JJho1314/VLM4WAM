#!/usr/bin/env bash
# Train MASK-FREE match-ground v3 with an additional InstructSAM decoder-dense
# spatial feature branch. I2V setting: 93 frames, stride 1, 1600 optimizer steps.

#SBATCH --job-name=cosmos-mgv3sp93
...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-mgv3sp93-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-mgv3sp93-%j.err
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-match_ground_v3_spatial_decoder_dense}
...
export IMAGINAIRE_OUTPUT_ROOT=${IMAGINAIRE_OUTPUT_ROOT:-/data/user/jhe724/workspace/cosmos-predict2.5/outputs/droid_v21_match_ground_v3_spatial_decoder_dense_93f_s1_vlm4wam}
...
EXPERIMENT=${EXPERIMENT:-predict2_video2world_training_2b_droid_success_v21_match_ground_v3_spatial_decoder_dense}
JOB_NAME=${JOB_NAME:-2b_mgv3_spatial_decoder_dense_iou50_93f_s1_bs1accum16_gbs128_1600}
