#!/usr/bin/env bash
# Train MASK-FREE match-ground v3 with a ControlNet/TAVID-style side residual.
# I2V setting: 49 frames, stride choices 1/2/3, 1600 optimizer steps.

#SBATCH --job-name=cosmos-mgv3ctrl49
...
#SBATCH --output=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-mgv3ctrl49-%j.out
#SBATCH --error=/data/user/jhe724/workspace/VLM4WAM/logs/slurm-mgv3ctrl49-%j.err
...
export WANDB_RUN_GROUP=${WANDB_RUN_GROUP:-match_ground_v3_control_side_branch}
...
export IMAGINAIRE_OUTPUT_ROOT=${IMAGINAIRE_OUTPUT_ROOT:-/data/user/jhe724/workspace/cosmos-predict2.5/outputs/droid_v21_match_ground_v3_control_side_branch_49f_s123_vlm4wam}
...
EXPERIMENT=${EXPERIMENT:-predict2_video2world_training_2b_droid_success_v21_match_ground_v3_control_side_branch}
JOB_NAME=${JOB_NAME:-2b_mgv3_control_side_branch_iou50_49f_s123_bs2accum8_gbs128_1600}
